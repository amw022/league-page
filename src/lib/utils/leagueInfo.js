/*   STEP 1   */
export const leagueID = "653364919286206464"; // your league ID
export const leagueName = "AAFF"; // your league name
...
export const managers = [
     {
       ...
       "location": "Fayetteville", // (optional)
...

    {
       ...
       "name": "David Robinson",
       "tookOver": 2013, // (optional) used if a manager took over a team, delete this line or change to null otherwise
       "location": "Wherever the bus parks", // (optional)
       "bio": "Praying not to be last",
    //   "photo": "/managers/name.jpg", // square ratio recommended (no larger than 500x500)
       "fantasyStart": 2013, // (optional) when did the manager start playing fantasy football
    ...
    //   "preferredContact": "Text", // 'Text', 'WhatsApp', 'Sleeper', 'Email', 'Phone', 'Discord', and 'Carrier Pigeon' are currently supplied in the template
     },
	  {
       ...
       "location": "Russellville", // (optional)
       "bio": "The Rich Doctor",
    //   "photo": "/managers/name.jpg", // square ratio recommended (no larger than 500x500)
    ...
    //   "preferredContact": "Text", // 'Text', 'WhatsApp', 'Sleeper', 'Email', 'Phone', 'Discord', and 'Carrier Pigeon' are currently supplied in the template
     },
	  {
       ...
       "name": "Kyle Ahern",
       "tookOver": 2017, // (optional) used if a manager took over a team, delete this line or change to null otherwise
       "location": "Springdale", // (optional)
       "bio": "He drinks. He knows things.",
    //   "photo": "/managers/name.jpg", // square ratio recommended (no larger than 500x500)
       "fantasyStart": 2008, // (optional) when did the manager start playing fantasy football
